    ...
    <div class="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
      ...
      <div class="w-full md:w-auto md:flex-grow md:flex md:items-center">
        <ul class="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 lg:mr-8 md:border-0">
          <li>
            <Link class="block px-4 py-1 md:p-2 lg:px-4" href="#" title="Link">TimeBoxing App</Link>
          </li>
          <li>
            <Link class="block px-4 py-1 md:p-2 lg:px-4 text-purple-600" href="#" title="Active Link">Active Link</Link>
          </li>
          <li>
        ...
        <ul class="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:ml-auto md:mt-0 md:pt-0 md:border-0">
          <button class="bg-indigo-500 px-5 py-2 text-white rounded-md hover:bg-indigo-700 focus:outline-none">Sign In</button>
        </ul>
      </div>
    </div>
  </nav>
