        ...
        <div class="container mx-auto">
            <div class="max-w-md mx-auto my-10">
                <div class="text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Create an account for free</p>
                </div>
                <div class="m-7">
                    <form action="">
                        <div class="mb-6">
                        ...
                        <p class="text-sm text-center text-gray-400">Already have an account? <Link href="/signin" class="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign in</Link>.</p>
                    </form>
                </div>
            </div>
        </div>
