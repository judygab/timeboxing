            ...
            <div class="max-w-md mx-auto my-10">
                ...
                <div class="m-7">
                    <form action="">
                        ...
                        <p class="text-sm text-center text-gray-400">Don&#x27;t have an account yet? <Link href="/signup" class="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign up</Link>.</p>
                    </form>
                </div>
            </div>
        </div>
